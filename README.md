...
git clone https://github.com/username/appiumWithRobotForMobile.git
...
robot -d reports/ tests/android/mobile.robot
...
All rights reserved. please contact for the collabrate.
