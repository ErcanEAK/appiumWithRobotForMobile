...
*** Test Cases ***
Open Application
    Open Application    http://127.0.0.1:4723/wd/hub    platformName=Android    deviceName=emulgator-5554    appPackage=${ANDROID_APP}    appActivity=MainActivity    automationName=UiAutomator2
